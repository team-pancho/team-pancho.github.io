				...
				<div id="header" class="row">
					<div class="4u">
						<div class="transparent">
							<h1><a href="index.html">CSS3<span class="header_colour">_waves</span></a></h1>
		...
		<div id="footer_container">
			...
			<!-- Footer -->
				<footer>
					...
					<p>Copyright &copy; CSS3_waves | <a href="http://fotogrph.com/">Images</a> | <a href="http://skeljs.org/">skel.js</a> | <a href="http://www.css3templates.co.uk">design from css3templates.co.uk</a></p>
				</footer>		
			</div>
        </div>		
	</body>
